...
# the_int = 1
# the_float = 2.5
# the_string = 'Welcome to Python'

# one = two = three = 1  # Integer object with value 1 and all three variables are assigned to same mem location
# the_num, the_float, the_string = 1, 2.5, 'String'  # Unpacking
